...
<section class="content">	
		...
		<form role="form" name="formRec" id="formRec" method="POST" action="<?php echo BASE_SISTEMA ?>possibilidades/cadastro">
...
<script type="text/javascript">
  ...
  $('#inputNome').bootcomplete({
   ...
   function validar(){
    ...
    if ( obj_alert.isvazioInput("inputNome", "Informe o nome do recurso que você necessita"))
        return false;
    ...
    if ( obj_alert.isvazioInput("id_categoria", "Selecione a Dimensão"))
        return false;
    
    if ( obj_alert.isvazioInput("status", "Status"))
        return false;
    
    if ( obj_alert.isvazioInput("tipo_fluxo", "Tipo de Fluxo"))
        return false;
