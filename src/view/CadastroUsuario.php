...
?>
    ...
    <form action="cadastro" method="post">
      <div class="form-group has-feedback">
        <input name="nome" type="text" class="form-control" placeholder="Nome completo" value="<?php echo ($usuario->getNome()) ?>" required>
      ...
      <div class="form-group has-feedback">
        <input name="confirma_senha" type="password" class="form-control" placeholder="Confirmar senha" required>
